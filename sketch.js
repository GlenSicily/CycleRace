...
var blueOpponentGroup,yellowOpponentGroup,redOpponentGroup
var obstacle1Group,obstacle2Group,obstacle3Group

var road,racer,opponentBlue,opponentYellow,opponentRed
var roadImage,racerImage1,racerImage2,opponentBlue1Image, opponentBlue2Image,opponentYellow1Image,opponentYellow2Image,opponentRed1Image,opponentRed2Image
...
function preload(){
  ...
  opponentBlue1Image=loadAnimation("images/opponent1.png","images/opponent2.png");
  opponentBlue2Image=loadAnimation("images/opponent3.png")
...
function draw(){
  ...
  if(blueOpponentGroup.isTouching(racer)){
    
  gameState=END
  racer.changeAnimation("racer",racerImage2);    
opponentBlue.addAnimation("opponentBlue",opponentBlue2Image)
  opponentBlue.velocityY=0
...
road.velocityX=0
  ...
  blueOpponentGroup.setLifetimeEach(-1)
  yellowOpponentGroup.setLifetimeEach(-1)
  redOpponentGroup.setLifetimeEach(-1)

  blueOpponentGroup.setVelocityXEach(0)
...
function blueCyclists(){
  ...
  opponentBlue=createSprite(600,Math.round(random(50,250),10,10));
  opponentBlue.addAnimation("opponentBlue",opponentBlue1Image)
    
  opponentBlue.velocityX=-(6+2*distance/150)
     
  opponentBlue.scale=0.07

  opponentBlue.setLifetime=150
  
  blueOpponentGroup.add(opponentBlue)
}
